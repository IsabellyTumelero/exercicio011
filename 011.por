/*
Médias
Este exemplo pede ao usuário que informe três médias. Logo após, calculae exibe a média final destas notas. Por fim, verifica se alguma das médias parciais é menor que a média final e exibe (caso exista).
*/
